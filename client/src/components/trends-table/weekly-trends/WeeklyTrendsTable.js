        ...
        <div className="col s8 offset-s2">
          <ul className="pagination">
            ...
            <li className="waves-effect">
              <a href="/trends/daily">Day</a>
            </li>
            <li className="active">
              <a href="#!">Week</a>
            </li>
            <li className="waves-effect">
              <a href="/trends/monthly">Month</a>
            </li>
            <li className="waves-effect">
              <a href="/trends/quarter">Quarter</a>
            </li>
            <li className="waves-effect">
              <a href="/trends/monthly">
            ...
            <tbody>
              {this.state.data.map(tranaction => (
                <tr
                  key={tranaction._id}
                  className={
                    tranaction.isEditing ? "background-active" : "test"
                  }
                >
                  {/* PRODUCT */}
                  ...
                  <td className="borders">
                    ...
                    {tranaction.product.productDepartment}{" "}
                  </td>
                  ...
                  <td>
                    ...
                    {tranaction.transaction.transactionDate}
                  </td>
                </tr>
              ))}
            </tbody>
